...
convex_hull* hull;
    ...
    void convexify(py::array_t<double> & phi_np, py::array_t<double> & dual_np){
    ...
    void pushforward_op(py::array_t<double> & phi_np, py::array_t<double> & nu_np){
...
PYBIND11_MODULE(w2, m) {
    ...
    py::class_<BFM>(m, "BFM")
        ...
        .def("convexify", &BFM::convexify)
        .def("step_update", &BFM::step_update)
        .def("pushforward_op", &BFM::pushforward_op)
